...
var (
	...
	subpkgEnable  = flag.Bool("subpkg-enable", false, "specify whether to enable subpkg; default disable")
	subpkgStyle   = flag.String("subpkg-style", "kebab", "specify the generation style for subpkg; options: kebab | under-score | lower | camel | pascal; default is kebab")
	counterName   = flag.String("counter-name", "", "specify the counter name; default is counter")
	fileNameStyle = flag.String("file-style", "under-score", "specify the generation style for file; options: kebab | under-score | lower | camel | pascal; default is under-score")
)
